...
public class LevelGrid : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        gridSystem = new GridSystem<GridObject>(width, height, cellSize, (GridSystem<GridObject> gameObject, GridPosition gridPosition) => new GridObject(gameObject, gridPosition));
